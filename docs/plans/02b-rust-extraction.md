# Rust Parser — Arbeitspaket B2: Extractor + PyO3 Bindings + Build

> **Arbeitspaket B2** — Teil 2 von 4 des Rust Parser Plans

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Den AST-Extractor fuer Python/TypeScript/Rust implementieren, die vollstaendigen PyO3-Bindings aufbauen und die Extension bauen/installieren. (Tasks 4, 5, 6)

**Tech Stack:** Rust, PyO3 0.22, maturin, Tree-sitter 0.24, serde, serde_json

**Design Document:** [2026-02-20-nemesis-design.md](2026-02-20-nemesis-design.md)

**Depends on:** [02a-rust-core-models.md](02a-rust-core-models.md) (Arbeitspaket B1)
...
**Gesamt B2: 3 Tasks, 20 Rust-Tests, 3 Commits**

---

**Navigation:**
- Vorheriges Paket: [B1 — Rust Core Models](02a-rust-core-models.md)
- Naechstes Paket: [B3 — Python Bridge](02c-python-bridge.md)
